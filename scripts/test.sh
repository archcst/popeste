...
cd "${0:A:h:h}"
mkdir -p .build/tests
swiftc Sources/Popaste/InterfaceText.swift Sources/Popaste/Localization.swift Sources/Popaste/Store.swift Sources/Popaste/Configuration.swift Sources/Popaste/Placement.swift Tests/PopasteTests/StoreTests.swift -o .build/tests/store-tests
